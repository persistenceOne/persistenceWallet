    ...
    try {
      ...
      await stakingQueryService
        ...
        .then((unbondingDelegationsResponse) => {
          // https://raw.githubusercontent.com/cosmostation/chainlist/master/chain/persistence/moniker/cosmosvaloper196ax4vc0lwpxndu9dyhvca7jhxp70rmcvrj90c.png
          if (unbondingDelegationsResponse.unbondingResponses.length) {
            dispatch(
              fetchUnbondDelegationsList(
