...
import {
  BondStatus as BondStatus1,
  bondStatusFromJSON as bondStatusFromJSON2,
  bondStatusToJSON as bondStatusToJSON3,
} from "../../cosmos/staking/v1beta1/staking";
import { Duration } from "../../google/protobuf/duration";
import { Coin } from "../../cosmos/base/v1beta1/coin";
import { Timestamp } from "../../google/protobuf/timestamp";

export const protobufPackage = "lsnative.staking.v1beta1";
...
export const Validator = {
  encode(
    ...
    if (message.totalValidatorBondShares !== "") {
      writer.uint32(98).string(message.totalValidatorBondShares);
    }
    if (message.totalLiquidShares !== "") {
      writer.uint32(106).string(message.totalLiquidShares);
    }
    return writer;
  },
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      status: isSet(object.status) ? bondStatusFromJSON2(object.status) : 0,
      ...
      totalValidatorBondShares: isSet(object.totalValidatorBondShares)
        ...
        : "",
      totalLiquidShares: isSet(object.totalLiquidShares)
        ? String(object.totalLiquidShares)
        : "",
    };
  },
  ...
  toJSON(message: Validator): unknown {
    ...
    message.status !== undefined &&
      (obj.status = bondStatusToJSON3(message.status));
    ...
    message.totalLiquidShares !== undefined &&
      (obj.totalLiquidShares = message.totalLiquidShares);
    return obj;
  },
...
export const Delegation = {
  ...
  fromJSON(object: any): Delegation {
    return {
      ...
      validatorBond: isSet(object.validatorBond)
  ...
  fromJSON(object: any): Params {
    return {
      ...
      minCommissionRate: isSet(object.minCommissionRate)
        ...
        : "",
      validatorBondFactor: isSet(object.validatorBondFactor)
...
function createBaseTokenizeShareRecord(): TokenizeShareRecord {
  return { id: Long.UZERO, owner: "", moduleAccount: "", validator: "" };
}
...
export const TokenizeShareRecord = {
  ...
  fromJSON(object: any): TokenizeShareRecord {
    return {
      ...
      moduleAccount: isSet(object.moduleAccount)
