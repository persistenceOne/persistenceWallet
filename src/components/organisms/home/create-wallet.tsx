    ...
    <>
      ...
      <div className={`px-8 py-6 m-0`}>
        <div className="p-6 bg-[#383838] mb-6">
          <p className="text-light-emphasis font-bold text-base leading-normal mb-2">
            Take a moment to read through this content for your own safety
          </p>
          <ul className="list-disc pl-8">
            <li className="text-light-mid font-normal text-base leading-normal mb-2">
              Users need to securely store their Mnemonic (seed phrase) to
              prevent loss of funds. Losing or exposing this phrase could
              potentially lead to users' funds being stolen.
            </li>
            <li className="text-light-mid font-normal text-base leading-normal">
