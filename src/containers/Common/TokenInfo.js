...
const TokenInfo = (props) => {
  ...
  const popoverVesting = (
    <Popover id="popover-vesting">
      <Popover.Content>{t("VESTING_NOTE")}</Popover.Content>
    </Popover>
  );
  const popoverDelegatable = (
    <Popover id="popover-vesting">
      <Popover.Content>{t("DELEGATABLE_NOTE")}</Popover.Content>
    </Popover>
  );
  const popoverTransferable = (
    <Popover id="popover-vesting">
      <Popover.Content>{t("TRANSFERABLE_NOTE")}</Popover.Content>
    </Popover>
  );

  const popoverTotal = (
    <Popover id="popover-total">
      <Popover.Content>{t("TOTAL_BALANCE_NOTE")}</Popover.Content>
    </Popover>
  );
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                >
                  <div>
                    <span className="address-truncate">
                      {stringTruncate(loginInfo?.coin118Response?.address, 10)}
                    </span>
                    <>
                ...
                >
                  <div className="">
                    <span className="address-truncate">
                      {stringTruncate(loginInfo?.coin750Response?.address, 10)}
                    </span>
